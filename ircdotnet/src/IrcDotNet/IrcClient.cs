...
namespace IrcDotNet
{
    ...
    public partial class IrcClient : IDisposable
    {
        ...
        private ConcurrentQueue<Tuple<string, object>> messageSendQueue;
        ...
        public IrcClient()
        {
            ...
            this.sendThread = new Thread(new ThreadStart(WritePendingMessages));
            ...
            this.messageSendQueue = new ConcurrentQueue<Tuple<string, object>>();
        ...
        private void WritePendingMessages()
        {
            ...
            {                
                try
                {
                    while (messageSendQueue.TryDequeue(out message))
                    {
                        if (floodPreventer != null)
                            Thread.Sleep((int)floodPreventer.GetSendDelay());
