...
{
    public partial class RooWallsViewer : UserControl
    {
        public event EventHandler SelectedItemChanged;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public RooWall SelectedItem
        {
            get
            {
                if (dataGrid == null || 
                ...
                {
                    return (RooWall)dataGrid.SelectedRows[0].DataBoundItem;
                }
            }
            set 
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public List<RooWall> DataSource
        {
            get { return (dataGrid.DataSource != null) ? (List<RooWall>)dataGrid.DataSource : null; }
            set
            {
