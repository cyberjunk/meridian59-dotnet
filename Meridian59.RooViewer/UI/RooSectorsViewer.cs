...
{
    public partial class RooSectorsViewer : UserControl
    {
        public event EventHandler SelectedItemChanged;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public RooSector SelectedItem
        {
            get
            {
                if (dataGrid == null ||
                ...
                {
                    return (RooSector)dataGrid.SelectedRows[0].DataBoundItem;
                }
            }
            set
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public List<RooSector> DataSource
        {
            get { return (dataGrid.DataSource != null) ? (List<RooSector>)dataGrid.DataSource : null; }
            set
            {
