...
namespace Meridian59.RooViewer.UI
{
    public partial class RooSidesViewer : UserControl
    {
        ...
        public RooSideDef SelectedItem
        {
            get
            {
                if (dataGrid == null ||
                ...
                {
                    return (RooSideDef)dataGrid.SelectedRows[0].DataBoundItem;
                }
            }
            set
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public List<RooSideDef> DataSource
        {
            get { return (dataGrid.DataSource != null) ? (List<RooSideDef>)dataGrid.DataSource : null; }
            set
            {
