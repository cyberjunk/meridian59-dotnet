...
{
    public partial class RooWallsEditorViewer : UserControl
    {
        public event EventHandler SelectedItemChanged;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public RooWallEditor SelectedItem
        {
            get
            {
                if (dataGrid == null || 
                ...
                {
                    return (RooWallEditor)dataGrid.SelectedRows[0].DataBoundItem;
                }
            }
            set 
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(null), Browsable(true)]
        public List<RooWallEditor> DataSource
        {
            get { return (dataGrid.DataSource != null) ? (List<RooWallEditor>)dataGrid.DataSource : null; }
            set
            {
