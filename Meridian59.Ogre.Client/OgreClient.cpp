...
namespace Meridian59 { namespace Ogre
{
	...
	void OgreClient::DemoSceneLoadBrax()
	{
		...
		tree1->LightingInfo = gcnew LightingInfo(gcnew LightFlags(1), 50, 320);
		...
		tree2->LightingInfo = gcnew LightingInfo(gcnew LightFlags(1), 50, 15360);
		...
		brazier->LightingInfo = gcnew LightingInfo(gcnew LightFlags(1), 40, 32518);
