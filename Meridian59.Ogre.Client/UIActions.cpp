...
namespace Meridian59 { namespace Ogre
{
   ...
   void ControllerUI::Actions::CreateItem(AvatarAction Type)
   {
      ...
      if (widget->getChildCount() > 1)
      {
         ...
         switch(Type)
         {
         case AvatarAction::Attack:       strIconName = UI_IMAGE_ACTION_ATTACK;        break;
         case AvatarAction::Rest:         strIconName = UI_IMAGE_ACTION_REST;          break;
         case AvatarAction::Dance:        strIconName = UI_IMAGE_ACTION_DANCE;         break;
         case AvatarAction::Wave:         strIconName = UI_IMAGE_ACTION_WAVE;          break;
         case AvatarAction::Point:        strIconName = UI_IMAGE_ACTION_POINT;         break;
         case AvatarAction::Loot:         strIconName = UI_IMAGE_ACTION_LOOT;          break;
         case AvatarAction::Buy:          strIconName = UI_IMAGE_ACTION_BUY;           break;
         case AvatarAction::Inspect:      strIconName = UI_IMAGE_ACTION_INSPECT;       break;
         case AvatarAction::Trade:        strIconName = UI_IMAGE_ACTION_TRADE;         break;
         case AvatarAction::Activate:     strIconName = UI_IMAGE_ACTION_ACTIVATE;      break;
         case AvatarAction::GuildInvite:  strIconName = UI_IMAGE_ACTION_GUILDINVITE;   break;
