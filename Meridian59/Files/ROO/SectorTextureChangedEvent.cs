...
{
    public delegate void SectorTextureChangedEventHandler(object sender, SectorTextureChangedEventArgs e);

    public class SectorTextureChangedEventArgs : EventArgs
    {
