...
namespace Meridian59.Data.Models
{
    ...
    /// </summary>
    [Serializable]
    public class UserCommandGuildShieldInfo : UserCommand
    {      
        /// <summary>
        ...
        public override int ByteLength { 
            get { 
                return TypeSizes.BYTE + ShieldInfo.ByteLength;
            }
        }       
        public override int WriteTo(byte[] Buffer, int StartIndex=0)
        {
            ...
            cursor += ShieldInfo.WriteTo(Buffer, cursor);
        ...
        public GuildShieldInfo ShieldInfo { get; set; }
        ...
        public UserCommandGuildShieldInfo(byte[] Buffer, int StartIndex = 0)
        {           
