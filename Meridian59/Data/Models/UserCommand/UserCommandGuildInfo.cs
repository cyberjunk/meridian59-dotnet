...
{
    [Serializable]
    public class UserCommandGuildInfo : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.GuildInfo; } }
        
        #region IByteSerializable implementation
        public override int ByteLength { 
            get { 
                // CommandType + GuildInfo
                return TypeSizes.BYTE + GuildInfo.ByteLength;
            }
        }
        ...
        public UserCommandGuildInfo(byte[] Buffer, int StartIndex = 0)
        {           
