...
{
    [Serializable]
    public class UserCommandWithDraw : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.WithDraw; } }
        ...
        public UserCommandWithDraw(uint Amount)
        {
            this.Amount = Amount;
        }

        public UserCommandWithDraw(byte[] Buffer, int StartIndex = 0)
        {           
