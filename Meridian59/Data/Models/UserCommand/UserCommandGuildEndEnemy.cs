...
{
    [Serializable]
    public class UserCommandGuildEndEnemy : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.EndEnemy; } }
        ...
        public UserCommandGuildEndEnemy(byte[] Buffer, int StartIndex = 0)
        {           
