...
{
    public class UserCommandTempSafe : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.TempSafe; } }
        ...
        public UserCommandTempSafe(byte OnOffFlag)
        {
            this.OnOffFlag = OnOffFlag;
        }

        public UserCommandTempSafe(byte[] Buffer, int StartIndex = 0)
        {           
