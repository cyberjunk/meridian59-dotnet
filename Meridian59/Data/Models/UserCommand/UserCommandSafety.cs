...
{
    public class UserCommandSafety : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.Safety; } }
        ...
        public UserCommandSafety(byte OnOffFlag)
        {
            this.OnOffFlag = OnOffFlag;
        }

        public UserCommandSafety(byte[] Buffer, int StartIndex = 0)
        {           
