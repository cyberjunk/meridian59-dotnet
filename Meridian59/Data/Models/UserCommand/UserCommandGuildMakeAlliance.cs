...
{
    [Serializable]
    public class UserCommandGuildMakeAlliance : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.MakeAlliance; } }
        ...
        public UserCommandGuildMakeAlliance(byte[] Buffer, int StartIndex = 0)
        {           
