...
{
    [Serializable]
    public class UserCommandGuildEndAlliance : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.EndAlliance; } }
        ...
        public UserCommandGuildEndAlliance(ObjectID GuildID)
        {
            this.GuildID = GuildID;
        }

        public UserCommandGuildEndAlliance(byte[] Buffer, int StartIndex = 0)
        {           
