...
{
    [Serializable]
    public class UserCommandGuildVote : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.Vote; } }
        ...
        public UserCommandGuildVote(byte[] Buffer, int StartIndex = 0)
        {           
