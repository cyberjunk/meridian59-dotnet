...
{
    [Serializable]
    public class UserCommandGuildShieldListReq : UserCommand
    {
        /// <summary>
        ...
        public UserCommandGuildShieldListReq()
        {           
        }

        public UserCommandGuildShieldListReq(byte[] Buffer, int StartIndex = 0)
        {           
