...
{
    [Serializable]
    public class UserCommandGuildAbdicate : UserCommand
    {
        public override UserCommandType CommandType { get { return UserCommandType.Abdicate; } }
        ...
        public UserCommandGuildAbdicate(byte[] Buffer, int StartIndex = 0)
        {           
