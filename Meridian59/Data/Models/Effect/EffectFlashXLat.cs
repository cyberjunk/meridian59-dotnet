...
namespace Meridian59.Data.Models
{
    ...
    /// </summary>
    [Serializable]
    public class EffectFlashXLat : DurationEffect
    {
        ...
        public EffectFlashXLat(uint Duration = 0, uint XLat = 0)
            : base(EffectType.FlashXLat, Duration)
        {
            this.XLat = XLat;
        }

        public EffectFlashXLat(byte[] Buffer, int StartIndex)
            : base(Buffer, StartIndex) { }

        public unsafe EffectFlashXLat(ref byte* Buffer)
            : base(ref Buffer) { }
        
        public override string ToString()
        {
            return "EffectFlashXLat";
        }
    }
}
