...
namespace Meridian59.Data.Lists
{
    ...
    /// </summary>
    [Serializable]
    public class SpellObjectList : ObjectBaseList<SpellObject>
    {
        public SpellObjectList(int Capacity = 5) : base(Capacity)
        {
        ...
        public override void Insert(int Index, SpellObject Item)
        {
            if (!isSorted)
            ...
            else
            {
                ...
                {
                    case SpellObject.PROPNAME_SCHOOLTYPE:
                        break;
                }*/
        ...
        public List<SpellObject> GetItemsByNamePrefix(string Prefix)
        {
            // list for results
            List<SpellObject> list = new List<SpellObject>();

            // prefix to lowercase
            string lowerPrefix = Prefix.ToLower();

            foreach (SpellObject obj in this)
            {
